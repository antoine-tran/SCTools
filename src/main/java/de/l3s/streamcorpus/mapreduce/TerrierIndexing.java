...
public class TerrierIndexing extends Configured implements Tool
{
	static final int MAX_REDUCE = 26;
	/** logger for this class */
	protected static final Logger logger = Logger.getLogger(TerrierIndexing.class);
	...
	public static void main(String[] args) {
		try {
			ToolRunner.run(new TerrierIndexing(), args);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
