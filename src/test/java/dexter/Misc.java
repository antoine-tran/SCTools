...
public class Misc {
	...
	public static void main(String[] args) {
		...
		String s = new MultiWordStringMatcher(MatchType.LNRM).getLnrmRegex(lemma.getLemmatization("Alice MOVIEs, % $:<'          ")).toLowerCase();
		/* 360 */     System.out.println(s);
		/* 361 */     String x = new MultiWordStringMatcher(MatchType.LNRM).getLnrmRegex(lemma.getLemmatization("alice_(movie)")).toLowerCase();
